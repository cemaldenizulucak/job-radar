import type { LocationSubdivision } from './locations.types.js';

/**
 * Official 81 Turkish provinces keyed by vehicle registration (plaka) code.
 * Used as the source of truth for TR subdivisions — not CSC / jsDelivr.
 */
export const TURKEY_PROVINCES: readonly LocationSubdivision[] = [
  { code: '01', name: 'Adana' },
